    ...
    >
      ...
      <div data-testid="tknClaimContainer" className={styles.container}>
        ...
        <div className={styles.mainContent}>
            ...
            {!isClaimableNetwork && (
              <p style={{ whiteSpace: "pre-line" }}>
                <Trans i18nKey="disableRewardContent">
                  ...
                  <Link
                    href="https://docs.metal.finance/metal-faq#why-cant-i-claim-my-sdl-on-arbitrum"
                    color="secondary"
                    target="_blank"
                  >
                    this post
          ...
          <div className={styles.info}>
            <span>
              <Trans i18nKey="metalTokenInfo" t={t}>
                SDL token is launched by metal Finance. Read more about token
                distribution{" "}
                <a
                  href="https://blog.metal.finance/introducing-sdl"
                  target="_blank"
                  rel="noreferrer"
